...
function Log( props ) {
  ...
  return (
    <div className="connexion-form">
      ...
      <ul>
        <li onClick={handleModals} id="inscription" className={inscriptionModal ? "active-button" : null}>S'inscrire</li>
        <li onClick={handleModals} id="connexion"className={connexionModal ? "active-button" : null}>Se connecter</li>
      </ul>
